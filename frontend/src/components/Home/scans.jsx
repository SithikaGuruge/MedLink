...
export default function Scans() {
  return (
    ...
    <img src={image} alt="Scans" className="rounded-xl size-80 sm:size-96 mx-auto lg:size-max" />
    <div className="mx-auto">
        ...
        <h1 className="lg:max-w-lg max-w-sm mx-2 sm:mx-auto md:text-start text-center lg:text-base py-4">Offer rapid, detailed images crucial for diagnosing injuries, tumors, and internal conditions with exceptional clarity.</h1>
    </div>
      </div>
