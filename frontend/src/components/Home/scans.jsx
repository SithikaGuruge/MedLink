      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5 py-6">
        ...
        <div className="mx-auto">
          <h1 className="lg:text-3xl font-bold text-center text-2xl lg:text-start">
            Precision Imaging at Your Fingertips
          </h1>
          <h1 className="lg:max-w-lg max-w-sm mx-2 sm:mx-auto md:text-start text-center lg:text-base py-4">
            Discover a new era of imaging efficiency with ScanSmart by Medi
            Link. Seamlessly manage and schedule scans, ensuring timely access
            to essential diagnostics for improved patient outcomes.
          </h1>
