    ...
    <>
      <div className="w-auto mx-auto  rounded-lg mr-40 p-0">
        ...
        <p className="text-gray-700 mb-4 text-start ">
          Mr. Charana Manawathilake and Mr. Lasana Subasinghe are well reputed
          radiologists with more than 30 years of work experience ensures you a
          clear, safe and efficient MRI scanning at his KCK Laborotories medical
          scanning centre located in Katubedda.
        </p>
        <p className="text-gray-600 mb-4">
          Available slots from <strong>26th March</strong>
        </p>
        <form className="space-y-4">
          <div className="flex">
            <label
              htmlFor="date"
              className="block text-gray-700 text-sm mb-2 w-20 text-start mt-2"
            >
              Date
            </label>
            <input
