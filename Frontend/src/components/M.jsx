...
return (
    <div className="max-w-sm mx-3.5 bg-[#A3D9F3] border border-solid border-r-4 rounded-2xl shadow-lg p-4 my-4 pt-1">
        ...
        <div className="text-lg text-gray-800 mb-2">
            <p className="my-2 font-semibold">Location: <span className='font-normal'>{props.location}</span> </p>
            <p className="my-2 font-semibold">Price: <span className='font-normal'>{props.price}</span></p>
        </div>
        ...
        <div className="flex mb-4 ">
            ...
            <div>
            <p className="flex justify-end w-auto text-sm  text-red-900 italic">Out Of Stocks</p>
            </div>
